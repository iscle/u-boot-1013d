...
#else
	sunxi_gpio_set_cfgpin(SUNXI_GPE(0), SUNXI_GPIO_DISABLE);
	sunxi_gpio_set_cfgpin(SUNXI_GPE(1), SUNXI_GPIO_DISABLE);
	sunxi_gpio_set_pull(SUNXI_GPE(1), SUNXI_GPIO_PULL_DISABLE);
#endif
...
#if !defined(CONFIG_ARM_CORTEX_CPU_IS_UP) && !defined(CONFIG_ARM64) && !defined(CONFIG_MACH_SUNIV)
